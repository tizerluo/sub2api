...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	grokQuotaService := service.ProvideGrokQuotaService(accountRepository, proxyRepository, grokTokenProvider, httpUpstream, usageLogRepository, tlsFingerprintProfileService)
